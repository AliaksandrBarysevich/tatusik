...
class ec_filter {
	...
	public function add_filter_atts( $productid, $category, $manufacturer, $status, $default_sort ) {
	...
	public function get_group_id() {
		if ( isset( $_GET['group_id'] ) ) {
			return $this->mysqli->get_category_id( (int) $_GET['group_id'] );
	...
	public function get_where_query() {
		...
		if ( $this->has_filters() || $this->product_only ) {
			...
			if ( ( $this->groupids && $this->groupids != ''  ) || ( $this->manufacturerids && $this->manufacturerids != '' ) || ( $this->productids && $this->productids != '' ) ) {
				$ret_string .= ' AND ( ';
				$attr_first = true;
